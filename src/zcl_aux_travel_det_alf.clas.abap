 CLASS zcl_aux_travel_det_alf DEFINITION
  PUBLIC
  FINAL
  CREATE PUBLIC .
  ...
  PUBLIC SECTION.
    ...
    TYPES: tt_travel_reported      TYPE TABLE FOR REPORTED z_i_travel_alf,
           tt_booking_reported     TYPE TABLE FOR REPORTED z_i_booking_alf,
           tt_supplements_reported TYPE TABLE FOR REPORTED z_i_booksuppl_alf.
...
CLASS zcl_aux_travel_det_alf IMPLEMENTATION.
